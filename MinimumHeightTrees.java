public class Solution {
    public List<Integer> findMinHeightTrees(int n, int[][] edges) {
        /**
         * Basically starts from the leaf nodes.
         ...
         * So in the end, the nodes in the queue would be connected to no other nodes but each other. They should be the answer.
         */ 
        ...
        for (int i = 0; i < n; i++) {
            ...
            else if (degree[i]==1) myQueue.offer(i);
        }
        ...
        while (!myQueue.isEmpty()) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                for (int k = 0; k < myGraph.get(curr).size(); k++) {
                    ...
                    if (degree[next] == 2) myQueue.offer(next);
                    degree[next]--;
                }
            }       
        }
